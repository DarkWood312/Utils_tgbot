...
def register_handlers(dp: Dispatcher):
    ...
    dp.message.register(chepy_start_handler, ChepyTool.main)
    dp.callback_query.register(chepy_callback_handler, ChepyTool.main)
    
    dp.message.register(binwalk_handler, Binwalk.wait_for_file )

    dp.message.register(exif_handler, Exif.wait_for_file)
